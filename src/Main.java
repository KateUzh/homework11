public class Main {
    ...
    public static void printInfoAboutVersion(int osType, int clientDeviceYear) {
        int relativeYear = 2015;
        if (osType == 0 && clientDeviceYear < relativeYear) {
            System.out.println("Установите облегчённую версию для iOS по ссылке");
        } else if (osType == 0 && clientDeviceYear >= relativeYear) {
            System.out.println("Установите версию приложения для iOS по ссылке");
        }
        if (osType == 1 && clientDeviceYear < relativeYear) {
            System.out.println("Установите облегчённую версию приложения для Android по ссылке");
        } else if (osType == 1 && clientDeviceYear >= relativeYear) {
